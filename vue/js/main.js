...
new Vue({
  ...
  mounted() {
    // this.shareURL = updateURL(initialQuote, initialAuthor);
    this.shareURL = 'http://google.com';
    ...
    onNewQuoteRequest() {
      ...
      makeRequest(apiURL)
        .then(response => {
          ...
          // this.shareURL = updateURL(newQuote, newAuthor);
          this.shareURL = 'http://terra.com.br';
          // pass new quote and author to data obj
          // this.updateState({
          //   quote: newQuote,
          //   author: newAuthor,
          //   
